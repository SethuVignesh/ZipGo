package com.theatro.zipgo.view.mapanimation;
...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        try {
            ...
            optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.YELLOW).width(5);
            ...
            ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), GREY, Color.YELLOW);
